...
tags: [release, v1.0.0]
version: 1.0.0
excerpt: "Major milestone with managed shade generator, step generator for numbers, multi-mode support, and preset imports. Includes collection filters, type filters, and ability to reuse existing variables for powerful design token workflows."
---
